...
class RegisterLandlordForm extends StatefulWidget {
  const RegisterLandlordForm({super.key});

  @override
  State<StatefulWidget> createState() => _RegisterLandlordFormState();
}

class _RegisterLandlordFormState extends State<RegisterLandlordForm> {
  ...
  void _submit() {
    ...
    context.read<RegisterLandlordBloc>().add(
      RegisterLandlordRequested(
  ...
  Widget build(BuildContext context) {
    return BlocConsumer<RegisterLandlordBloc, RegisterLandlordState>(
      listener: (context, state) {
        if (state is RegisterLandlordLoadFailure) {
          showToast(message: state.failure.message, type: ToastType.error);
        }

        if (state is RegisterLandlordLoadSuccess) {
          showToast(message: "Đăng ký thành công", type: ToastType.success);
          context.goNamed(RouteNames.login);
        }
      },
      builder: (context, state) {
        final isLoading = state is RegisterLandlordLoadInProgress;
