...
class _UpdatePropertyViewState extends State<_UpdatePropertyView> {
  ...
  void _submit() {
    context.read<UpdatePropertyBloc>().add(UpdatePropertySubmitted(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          title: const Padding(
            ...
            child: Text("Cập nhật nhà trọ", textAlign: TextAlign.center,
                    ...
                    Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          const SizedBox(height: 16),
                          _label("Mô tả"), _field(_descCtrl, "Mô tả thêm...", maxLines: 3),
                        ],
                      ),
                    ),
