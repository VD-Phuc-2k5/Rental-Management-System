  ...
  Widget _buildSectionHeader(IconData icon, String title) {
    return Row(
      children: [
        ...
        Text(title, style: const TextStyle(fontFamily: "Public Sans", fontWeight: FontWeight.w700, fontSize: 16, color: AppColors.blue700)),
      ],
    );
  }
  ...
  Widget _buildTextField({required String initialText, int maxLines = 1}) {
    ...
    return TextField(
      ...
      decoration: InputDecoration(
        ...
        enabledBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(5.0), borderSide: const BorderSide(color: AppColors.slate300, width: 1.0)),
